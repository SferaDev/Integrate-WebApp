    ...
    onSentClicked(event) {
        ...
        if (this.state.salesmanFirstName === '' || this.state.salesmanLastName === '' || this.state.email === '' || this.state.nif === '' || this.state.name === '' || this.state.addressName === '' || this.state.description === '' || this.state.phone === '') {
            ...
            const entity = {
                ...
                location: [this.state.addressLongitude, this.state.addressLatitude]
            }
            console.log(entity)
...
**/
                ...
                <Modal isOpen={this.state.modal} toggle={this.onSentClicked} className={this.props.className}>
                    ...
                    <ModalFooter>
                        <Button color="primary" onClick={this.onSentClicked}>Acceptar</Button>{' '}
                    </ModalFooter>
                </Modal>
